...
const AddNewProduct = () => {
  return (
    <div className="content-area p-6">
      <div className="mr-breadcrumb mb-4">
        <h4 className="heading text-2xl font-semibold">Add Product</h4>
        <ul className="links flex space-x-4">
          <li>
            <Link to="/admin" className="text-blue-500 hover:underline">Dashboard</Link>
          </li>
          <li>
            <span className="text-gray-600">Products</span>
          </li>
          <li>
            <Link to="/admin/products" className="text-blue-500 hover:underline">All Products</Link>
          </li>
          <li>
            <Link to="/admin/products/types" className="text-blue-500 hover:underline">Add Product</Link>
          </li>
        </ul>
      </div>
